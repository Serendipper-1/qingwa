/*
京喜财富岛
cron 1 * * * * https://raw.githubusercontent.com/EchoChan314/xxx/main/jd_cfd.js
更新时间：2021-10-16
活动入口：京喜APP-我的-京喜财富岛
...
[task_local]
#京喜财富岛
1 * * * * https://raw.githubusercontent.com/EchoChan314/xxx/main/jd_cfd.js, tag=京喜财富岛, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "1 * * * *" script-path=https://raw.githubusercontent.com/EchoChan314/xxx/main/jd_cfd.js,tag=京喜财富岛

===============Surge=================
京喜财富岛 = type=cron,cronexp="1 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/EchoChan314/xxx/main/jd_cfd.js

============小火箭=========
京喜财富岛 = type=cron,script-path=https://raw.githubusercontent.com/EchoChan314/xxx/main/jd_cfd.js, cronexpr="1 * * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/EchoChan314/xxx@main/jdWealthIslandCode.json')
  if (!res) {
    ...
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/EchoChan314/xxx@main/jdWealthIslandCode.json')
  }
