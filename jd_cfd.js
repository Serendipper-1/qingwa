...
!(async () => {
  ...
  await requestAlgo();
  await $.wait(1000)
  let res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/EchoChan314/xxx@main/CfdCode.json')
  if (!res) {
    ...
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/EchoChan314/xxx@main/CfdCode.json')
  }
